    ...
    <div className="min-h-[85vh] py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          {/* Facebook — แก้ลิงก์เฟซบุ๊กตรงนี้ */}
          <a href="https://www.facebook.com/share/1EmdvU4Jwu/" target="_blank" rel="noopener noreferrer"
            ...
            <div>
              ...
              <p className="text-white font-semibold text-lg group-hover:text-blue-400 transition-colors">GB Money Shop</p>
            </div>
          </a>

          {/* Email — แก้อีเมลตรงนี้ */}
