...
export default function Home() {
  ...
  return (
    <div className="bg-transparent">
      ...
      <section className="max-w-7xl mx-auto px-6 pt-32 pb-40">
        <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-10">
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            <Link to="/products" className="text-[#000000] font-black flex items-center gap-3 hover:translate-x-2 transition-transform py-6 px-12 bg-white/50 backdrop-blur-sm rounded-[24px] border border-blue-100 shadow-soft">
      ...
      {/* ===== TRUST SECTION ===== */}
      <section className="bg-blue-50/20 py-40 border-y border-blue-100/30">
         <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-24">
            <div className="text-center group">
               <div className="w-20 h-20 bg-white rounded-3xl flex items-center justify-center text-primary mx-auto mb-8 shadow-soft border border-blue-100 group-hover:bg-primary group-hover:text-white transition-all"><ShieldCheck size={36} /></div>
            ...
            <div className="text-center group">
               <div className="w-20 h-20 bg-white rounded-3xl flex items-center justify-center text-primary mx-auto mb-8 shadow-soft border border-blue-100 group-hover:bg-primary group-hover:text-white transition-all"><Zap size={36} /></div>
            ...
            <div className="text-center group">
               <div className="w-20 h-20 bg-white rounded-3xl flex items-center justify-center text-primary mx-auto mb-8 shadow-soft border border-blue-100 group-hover:bg-primary group-hover:text-white transition-all"><MessageSquare size={36} /></div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-40">
        ...
        >
          <a href="https://lin.ee/Z1pMLkJ" target="_blank" rel="noopener noreferrer"
            className="p-10 bg-white/80 backdrop-blur-sm border border-blue-100 rounded-[48px] hover:border-blue-200 hover:-translate-y-2 transition-all group text-center shadow-soft block">
          ...
          <a href="mailto:support@gbmoney.com"
            className="p-10 bg-white/80 backdrop-blur-sm border border-blue-100 rounded-[48px] hover:border-blue-200 hover:-translate-y-2 transition-all group text-center shadow-soft block md:col-span-2 lg:col-span-1">
            <div className="w-20 h-20 bg-blue-50/30 rounded-[28px] flex items-center justify-center mb-10 group-hover:bg-primary transition-all mx-auto shadow-sm">
              <Mail size={40} className="text-[#000000] group-hover:text-white" />
            </div>
            <p className="text-[10px] text-[#555555] uppercase font-black mb-1 tracking-[0.4em]">Email Support</p>
            <p className="text-[#000000] font-black text-2xl lowercase">support@gbmoney.com</p>
          </a>
        </motion.div>
      </section>
    </div>
